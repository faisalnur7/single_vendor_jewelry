...
@section('page_title', 'Privacy Policy List')

@section('contents')
<div class="container-fluid">
    <div class="card">
        <div class="card-header bg-gradient-dark text-white rounded-top d-flex justify-content-between align-items-center">
            <h3 class="card-title mb-0">Privacy Policy List</h3>
            <a href="{{ route('privacy_policy.create') }}" class="btn btn-primary btn-sm ml-auto">
                    ...
                    <tbody>
                        @forelse ($policies as $policy)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('privacy_policy.edit', $policy->id) }}" class="btn btn-outline-dark btn-sm" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('privacy_policy.delete', $policy->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')

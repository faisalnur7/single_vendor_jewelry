...
@section('title', 'Custom Category Create')
@section('page_title', 'Add Custom Category')
    ...
    <div class="container-fluid">
        <div class="card">
            <div
                ...
                <h3 class="card-title">Add New Custom Category</h3>
            </div>
            <div class="card-body">
                <!-- Form to create custom category -->
                <form action="{{ route('custom-category.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name"
                            class="form-control slugify @error('name') is-invalid @enderror" value="{{ old('name') }}"
                            required>
                        @error('name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="slug" id="slug"
                            class="form-control slug_text @error('slug') is-invalid @enderror" value="{{ old('slug') }}"
                            required>
                        @error('slug')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-success">Save Custom Category</button>

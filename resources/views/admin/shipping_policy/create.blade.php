...
@section('title','Add Shipping Policy')
@section('page_title','Add Shipping Policy')

@section('contents')
<div class="container-fluid">
    <div class="card">
        <div class="card-header bg-gradient-dark text-white rounded-top d-flex justify-content-between align-items-center">
            <h3 class="card-title mb-0">Add New Shipping Policy</h3>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('shipping_policy.store') }}" method="POST">
                @csrf

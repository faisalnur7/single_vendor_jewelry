...
@section('page_title', 'Attribute list')
    ...
    <div class="container-fluid">
        <div class="card">
            <div
                ...
                <a href="{{ route('attribute.create') }}" class="btn btn-primary btn-sm ml-auto">
                            ...
                            @forelse ($attributes as $attribute)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('attribute.delete', $attribute->id) }}" method="POST"
